...
/**
 * TopDiagnosaSearch represents the model behind the search form of `app\models\TopDiagnosa`.
 */
class TopDiagnosaSearch extends TopDiagnosa
{
    /**
     * {@inheritdoc}
     */
