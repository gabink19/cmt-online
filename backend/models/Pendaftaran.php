...
class Pendaftaran extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['td_tp_nikes', 'td_rekam_medis', 'td_tujuan', 'td_tp_nik', 'td_umur', 'td_tp_nama_kk', 'td_tp_no_bpjs', 'td_tp_band_posisi', 'td_tp_jenis_peserta', 'td_mitra', 'first_user', 'first_ip', 'last_user', 'last_ip'], 'string', 'max' => 255],
            [['td_hak_kelas'], 'string', 'max' => 20],
            [['td_id'], 'unique'],
            [['td_tp_nikes'], 'searching'],
        ];
    }
    public function searching()
    {
        $cari = Peserta::find()->where(['=','tp_nikes', $this->td_tp_nikes])->one();
        if ($cari=='') {
    ...
    public function attributeLabels()
    {
        return [
            ...
            'td_tp_jenis_peserta' => 'Jenis Peserta',
