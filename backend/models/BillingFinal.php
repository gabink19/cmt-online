...
class BillingFinal extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['tbs_biaya'], 'safe'],
            [['tgl_billing', 'tgl_billing_diresponse', 'first_date_backend', 'last_date_backend', 'tbs_id_user_backend','first_date_frontend', 'last_date_frontend', 'tbs_id_user_frontend','tbs_path_resume'], 'safe'],
