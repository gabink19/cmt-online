...
<div class="rujukan-form">
    ...
    <div class="col-md-12 rujukan-div">
        <div class="col-md-7 rujukan-divchild">
            <img src="image\logoyakes.png" width="250px">
        </div>
        <div class="col-md-5 rujukan-divchild" style="">
            <label class="control-label col-xs-4 text-left">No. Registrasi </label><label class="col-md-5">: <?= $model->tr_no_regis ?></label><br>

            <label class="control-label col-xs-4 text-left">No. Rujukan </label><label class="col-md-5">: <?= $model->tr_no_rujukan ?></label><br>
        </div>
        <div class="col-md-6">
