...
use backend\Controllers\ReportTrackingHistoryController;
use yii\helpers\ArrayHelper;
use kartik\export\ExportMenu;
use backend\models\Diagnosa;

/* @var $this yii\web\View */
/* @var $searchModel backend\models\ReportTrackingHistorySearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Report Case Monitoring';
...
$columnExport=[
            ...
            [
                ...
                'value'=>function($model){
                    return ReportTrackingHistoryController::getDaftar($model->tbs_td_id);
            ...
            [
                ...
                'attribute'=>'tbs_td_id',//nama
                'value'=>function($model){
                    return ReportTrackingHistoryController::getDaftar($model->tbs_td_id,2);
            ...
            [
                ...
                'attribute'=>'tbs_td_id',//nama
                'value'=>function($model){
                    $data = ReportTrackingHistoryController::getDaftar($model->tbs_td_id,3);
            ...
            [
                ...
                'value'=>function($model){
                    $data = ReportTrackingHistoryController::getDaftar($model->tbs_td_id,4);
            ...
            [
                ...
                'value'=>function($model){
                    return ReportTrackingHistoryController::getDaftar($model->tbs_td_id,1);
...
?>
<div class="report-tracking-history-index">
    ...
    <!-- <div class="col-md-2 col-xs-2"> -->
        <?php // Html::a('Export Data', ['csv'], ['class' => 'btn btn-success','target'=>'_blank']); ?>
    <!-- </div> -->
    <div class="col-md-2 col-xs-2">
            <?php 
