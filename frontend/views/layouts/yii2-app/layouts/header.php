...
<?php 
    ...
    $query = 'SELECT count(*) FROM tbl_notifikasi WHERE tn_link like "%persetujuan%" AND tn_user_mitra="'.@Yii::$app->user->id.'" AND tn_type_notif="1" AND tn_telah_dikirim="1" AND tn_telah_dibaca="0" AND flag_deleted="0"' ;
    $counto = Yii::$app->db->createCommand($query)->queryScalar();

    // $query = 'SELECT count(*) FROM tbl_notifikasi WHERE tn_link like "%pendaftaran%" AND tn_user_mitra="'.@Yii::$app->user->id.'" AND tn_type_notif="1" AND tn_telah_dikirim="1" AND tn_telah_dibaca="0" AND flag_deleted="0"' ;
    // $counto1 = Yii::$app->db->createCommand($query)->queryScalar();

    $query = 'SELECT count(*) FROM tbl_notifikasi WHERE tn_link like "%billing-final%" AND tn_user_mitra="'.@Yii::$app->user->id.'" AND tn_type_notif="1" AND tn_telah_dikirim="1" AND tn_telah_dibaca="0" AND flag_deleted="0"' ;
