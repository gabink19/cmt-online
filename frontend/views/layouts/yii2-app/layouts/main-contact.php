            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text">
                        <h3>contact</h3>
                        <p><a href="<?= Url::to(['portal'])?>">Home /</a> contact</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="contact-section">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <form class="form-contact contact_form" action="<?= Url::to(['sendmail'])?>" method="post" id="contactForm" novalidate="novalidate">
                            <div class="row">
                                <div class="col-12">
                    ...
                    <div class="col-lg-3 offset-lg-1">
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3>Percetakan Negara No 17 A,</h3>
                                <p> Jakarta Pusat</p>
                            </div>
                        </div>
                        <div class="media contact-info">
                        ...
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3>cmtonline.care@gmail.com</h3>
