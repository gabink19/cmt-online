...
$urlnikes = Url::to(['select-nikes']);
$urlnik = Url::to(['select-nik']);
...
<div class="peserta-search">
    ...
    ?>
     ...
     <?= 
    $form->field($model, 'tp_nik')->widget(Select2::classname(), [
                        // 'options' => ['placeholder' => 'Pilih Nik'],
                        // 'hideSearch' => false,
                        // 'data' => ArrayHelper::map(Peserta::find()->all(),'tp_nik','tp_nik'),
                        'data' =>[],
                        'options' => ['placeholder' => 'Pilih Nik'],
                        'hideSearch' => false,
                        'pluginOptions' => [
