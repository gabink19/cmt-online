    ...
    <p>
        <?php
         if ($model->tpt_flag_status=='') {
            echo Html::a('Update', ['update', 'id' => $model->tpt_id], ['class' => 'btn btn-primary']);
...
<div class="row">
    ...
    <div>
        <?= Html::a('Save To PDF',Url::to(['downloadpdf','id'=>$_GET['id'],'uniq_code'=>$_GET['uniq_code']]), ['class' => 'btn btn-success', 'target' => '_blank','style'=>'margin-right:2px;']);
        ?>
    </div>
