            ...
            [
                ...
                'buttons' => [
                    ...
                    'update' => function ($url, $model,$key) {
                        ...
                        // return $data;
                        return ($avail>0)?'':Html::a('<span class="glyphicon glyphicon-edit"></span>',Url::to(['billing-sementara/instant-create']).'&id='.$model['td_id'].'&nikes='.$model['td_tp_nikes'], [
