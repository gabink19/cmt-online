...
/**
 * BillingFinalSearch represents the model behind the search form of `frontend\models\BillingFinal`.
 */
class BillingFinalSearch extends BillingFinal
{
    /**
     * {@inheritdoc}
     */
    ...
    public function search($params)
    {
        ...
        if (isset($params['BillingFinalSearch']['start_periode'])) {

            if ($params['BillingFinalSearch']['start_periode'] != "" && $params['BillingFinalSearch']['stop_periode'] != "") {

                $query = $query->andWhere(['between','tgl_billing',$params['BillingFinalSearch']['start_periode'].' 00:00:00',$params['BillingFinalSearch']['stop_periode'].' 23:59:59']);
            }
        }else{
     ...
     * @return ActiveDataProvider
     */
    public function historysearchChild($params,$tbs_tp_nikes)
    {
        $query = BillingFinal::find()->where(['=', 'tbs_tp_nikes', $tbs_tp_nikes]);
