 ...
 */
class BillingFinal extends \yii\db\ActiveRecord
{
    public $rekmed;
    public $tujuan;
    public $nama_peserta;
    ...
    public function rules()
    {
        return [
            ...
            [['tbs_biaya'], 'safe'],
            [['tgl_billing', 'tgl_billing_diresponse', 'first_date_backend', 'last_date_backend', 'first_date_frontend', 'last_date_frontend', 'tbs_id_user_frontend','tbs_path_resume'], 'safe'],
            [['tbs_tp_nikes', 'tbs_path_billing', 'tbs_flag_status', 'tbs_id_user_backend', 'tbs_nama_mitra', 'tbs_nama_user_backend', 'first_ip_backend', 'last_ip_backend', 'first_ip_frontend', 'last_ip_frontend', 'first_user_backend', 'last_user_backend', 'first_user_frontend', 'last_user_frontend'], 'string', 'max' => 255],
        ];
    }
